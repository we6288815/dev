...
(function(e , t) {
        ...
        function i(e , t) {
                e.cd = 0;w(t, e);var n = t.find(".tp-bannertimer");
                if (n.length > 0) {
                        n.stop();n.css({
                                width : "0%"
                        });n.animate({
        ...
        function s(n , r) {
                ...
                var f = a.parent();
                f.width(r.thumbWidth * r.thumbAmount);f.height(r.thumbHeight);f.parent().width(r.thumbWidth * r.thumbAmount);f.parent().height(r.thumbHeight);n.find(">ul:first >li").each(function(e) {
        ...
        function u(e , t , n) {
                e.stop();e.find(".tp-thumbcontainer").animate({
                        left : t + "px"
                }, {
                        duration : n,
                        queue : false
        ...
        function f(e , n) {
                ...
                if (n.navigationArrow == "none")
                        s = "visibility:none";
                e.parent().append('<div style="' + s + '" class="tp-leftarrow tparrows ' + n.navigationStyle + '"></div>');e.parent().append('<div style="' + s + '" class="tp-rightarrow tparrows ' + n.navigationStyle + '"></div>');e.parent().find(".tp-rightarrow").click(function() {
                        if (n.transition == 0) {
                                if (e.data("showus") != t && e.data("showus") != -1)
                                        n.next = e.data("showus") - 1;else
                                        n.next = n.next + 1;
                                e.data("showus", -1);
        ...
        function c(e , t) {
                ...
                n.hover(function() {
                        clearTimeout(e.data("hidethumbs"));r.animate({
                                opacity : 1
                        }, {
                                duration : 200,
                                queue : false
                        ...
                        e.addClass("hovered");clearTimeout(e.data("hidethumbs"));
                        if (t.ie) {
                                r.css({
                                        visibility : "visible"
                                })
        ...
        function h(t , n) {
                ...
                if (n.navigationType == "bullet") {
                        ...
                        if (!o.hasClass("tp-thumbs")) {
                                f = 0;o.find(".bullet").each(function() {
                        ...
                        if (n.navigationArrows == "nexttobullets") {
                                i.removeClass("large");s.removeClass("large");i.removeClass("thumbswitharrow");s.removeClass("thumbswitharrow");i.css({
                                        visibility : "visible"
                                });s.css({
                                        visibility : "visible"
                                });
                                ...
                                if (n.navigationArrows == "verticalcentered") {
                                        i.addClass("large");s.addClass("large");i.css({
                                                visibility : "visible"
                                        });s.css({
                                                visibility : "visible"
                                        });
        ...
        function p(e , n) {
                ...
                n.fh = i;
                if (e.data("orgw") == t) {
                        e.data("orgw", e.width());e.data("orgh", e.height())
                }
                if (n.fullWidth == "on") {
                        ...
                        if (e.width() > s) {
                                e.data("fxof", s / 2 - e.width() / 2);e.css({
                                        position : "absolute",
                                        left : e.data("fxof") + "px"
                                })
                        }
                        ...
                        if (e.height() > o && e.data("fullwidthcentering") == "on") {
                                e.data("fyof", o / 2 - e.height() / 2);e.css({
                                        position : "absolute",
                                        top : e.data("fyof") + "px"
                                })
                        }
                } else {
                        e.width(n.width);e.height(e.height() * r);
                        if (e.height() < n.height && e.height() != 0 && e.height() != null) {
                                e.height(n.height);e.width(e.data("orgw") * i)
                        }
                }
                e.data("neww", e.width());e.data("newh", e.height());
                if (n.fullWidth == "on") {
                ...
                n.find(".tp-caption").each(function() {
                        ...
                        if (r.data("link") != t) {
                                ...
                                if (i == "slide") {
                                        ...
                                        o = "no";r.append('<div class="tp-caption sft slidelink" data-x="0" data-y="0" data-linktoslide="' + o + '" data-start="0"><a target="' + s + '" href="' + i + '"><div></div></a></div>')
                                }
                        }
                });n.find(">ul:first >li >img").each(function(t) {
                        var n = e(this);
                        n.addClass("defaultimg");p(n, r);p(n, r);n.wrap('<div class="slotholder"></div>');n.css({
                                opacity : 0
                        });n.data("li-id", t)
                })
        }
        ...
        function w(n , r) {
                ...
                if (u.data("transition") == "boxslide")
                        ...
                        l = 21;else {
                        l = Math.round(Math.random() * 21);u.data("slotamount", Math.round(Math.random() * 12 + 4))
                }
                ...
                if (!e.support.transition && l > 16) {
                        l = Math.round(Math.random() * 16);u.data("slotamount", Math.round(Math.random() * 12 + 4))
                }
                ...
                if (u.data("rotate") == t)
                        ...
                        r.rotate = Math.round(Math.random() * 360);else
                ...
                if (l == 0) {
                        ...
                        u.css({
                                opacity : 1
                        });g(a, r, true);g(f, r, false);f.find(".defaultimg").css({
                                opacity : 0
                ...
                if (l == 1) {
                        ...
                        u.css({
                                opacity : 1
                        });g(f, r, false);f.find(".defaultimg").css({
                                opacity : 0
                        });f.find(".slotslide").each(function(t) {
                                var s = e(this);
                                s.css({
                ...
                if (l == 2) {
                        h = h + 200;u.css({
                                opacity : 1
                        });v(a, r, true);v(f, r, false);f.find(".defaultimg").css({
                                opacity : 0
                ...
                if (l == 3) {
                        h = h + 200;u.css({
                                opacity : 1
                        });m(a, r, true);m(f, r, false);f.find(".defaultimg").css({
                                opacity : 0
                        });a.find(".slotslide").each(function() {
                                var t = e(this);
                                t.transit({
                ...
                if (l == 4) {
                        u.css({
                                opacity : 1
                        });v(a, r, true);v(f, r, true);f.find(".defaultimg").css({
                                opacity : 0
                ...
                if (l == 8) {
                        h = h * 3;u.css({
                                opacity : 1
                        });m(a, r, true);m(f, r, true);f.find(".defaultimg").css({
                                opacity : 0
                        });a.find(".slotslide").each(function() {
                                var t = e(this).find("img");
                                t.transition({
                ...
                if (l == 9) {
                        ...
                        r.slots = r.width / 20;v(f, r, true);f.find(".defaultimg").css({
                                opacity : 0
                        });
                        var p = 0;
                        f.find(".slotslide").each(function(t) {
                                ...
                                p++;n.transition({
                                        ...
                                        x : 0,
                                        y : 0
                                }, 0);n.data("tout", setTimeout(function() {
                                        n.transition({
                                                x : 0,
                                                y : 0,
                                                opacity : 1
                ...
                if (l == 10) {
                        ...
                        r.slots = r.height / 20;m(f, r, true);f.find(".defaultimg").css({
                                opacity : 0
                        });
                        var p = 0;
                        f.find(".slotslide").each(function(t) {
                ...
                if (l == 11) {
                        ...
                        r.slots = 1;v(f, r, true);f.find(".defaultimg").css({
                                opacity : 0
                        });
                        var p = 0;
                        f.find(".slotslide").each(function(t) {
                ...
                if (l == 12 || l == 13 || l == 14 || l == 15) {
                        ...
                        r.slots = 1;v(f, r, true);v(a, r, true);a.find(".defaultimg").css({
                                opacity : 0
                ...
                if (l == 16) {
                        i.css({
                                ...
                                position : "absolute",
                                "z-index" : 15
                        });i.wrapInner('<div class="tp-half-one"></div>');i.find(".tp-half-one").clone(true).appendTo(i).addClass("tp-half-two");i.find(".tp-half-two").removeClass("tp-half-one");i.find(".tp-half-two").wrapInner('<div class="tp-offset"></div>');
                        ...
                        if (!e.support.transition) {
                                ...
                                i.find(".tp-half-one").transition({
                                        ...
                                        rotate : N,
                                        y : 0 - r.height / 1.4 + "px"
                                }, 800, "in");i.find(".tp-half-two").transition({
                                        opacity : 1,
                                        scale : O,
                                        rotate : C,
                                        y : 0 + r.height / 1.4 + "px"
                        ...
                        f.find(".slotslide").each(function(t) {
                                ...
                                n.parent().css({
                                        ...
                                        if (c == 1) n.transition({
                                                        ...
                                                        top : 0 - r.height / 2,
                                                        rotate3d : "1, 0, 0, 90deg"
                                                }, h * 2, function() {});else n.transition({
                                                        opacity : .6,
                                                        left : 0,
                                                        top : 0 + r.height / 2,
                                                        rotate3d : "1, 0, 0, -90deg"
                ...
                if (l == 20) {
                        ...
                        u.css({
                                ...
                                n.transition({
                                        ...
                                        perspective : 500,
                                        rotate3d : "1, 5, 0, 5deg"
                                }, 300, "in-out");a.find(".defaultimg").css({
                                        opacity : 0
                                });setTimeout(function() {
                                        if (c == 1) n.transition({
                                                        top : 0,
                                                        ...
                                                        opacity : 0
                                                }, h * 2, "out", function() {});else n.transition({
                                                        top : 0,
                                                        left : 0 - r.width / 2,
                                                        perspective : r.width,
                                                        rotate3d : "0, -3, 0, -70deg",
                        ...
                        u.css({
                                ...
                                n.transition({
                                        ...
                                        if (c == 1) n.transition({
                                                ...
                                                }, h * 1.5, function() {});else n.transition({
                                                        top : 0,
                                                        left : 0 - r.width / 2,
                                                        perspective : r.width,
                                                        rotate3d : "0, 1000, 0, +90deg"
                ...
                var D = {};
                D.slideIndex = r.next + 1;n.trigger("revolution.slide.onchange", D);n.trigger("revolution.slide.onvideostop")
        }
        function E() {
        }
        function S(t) {
                ...
                n.find(".tp-caption").each(function(i) {
                        ...
                        if (a == 0) {
                                ...
                                if (offsetx < 0)
                                        offsetx = 0;
                                var f = 0;
                                clearTimeout(u.data("timer"));clearTimeout(u.data("timer-end"));
                                                ...
                                                if (n.attr("src").toLowerCase().indexOf("youtube") >= 0) {
                                                        if (!n.hasClass("HasListener")) {
                                                                try {
                                                                        ...
                                                                        n.addClass("HasListener");u.data("player", r)
                                                                } catch (i) {}
                                                        }
                                                } else {
                                                        if (n.attr("src").toLowerCase().indexOf("vimeo") >= 0) {
                                                                if (!n.hasClass("HasListener")) {
                                                                        n.addClass("HasListener");n.attr("id", l);
                                                                        var s = n.attr("src");
                                                                        var o = {},
                                                                                a = s,
                                                                                f = /([^&=]+)=([^&]*)/g,
                                ...
                                if (u.find("img").length > 0) {
                                        ...
                                        var d = p.data("ww");
                                        var v = p.data("hh");
                                        p.width(d * r.bw);p.height(v * r.bh);
                                        c = p.width();
                                        h = p.height()
                                } else {
                                        if (u.find("iframe").length > 0) {
                                ...
                                if (u.hasClass("randomrotate")) {
                                        ...
                                        u.data("repx", E);u.data("repy", T);u.data("repo", u.css("opacity"));u.data("rotate", w);u.data("scale", b);u.transition({
                                                opacity : 0,
                                                scale : b,
                                                rotate : w,
                                                x : E,
                                ...
                                u.data("timer", setTimeout(function() {
                                        ...
                                        if (u.hasClass("fade")) {
                                                u.data("repo", u.css("opacity"));u.animate({
                                                        opacity : 1
                                                }, {
                                        ...
                                        if (u.hasClass("lfr") || u.hasClass("lfl") || u.hasClass("sfr") || u.hasClass("sfl") || u.hasClass("lft") || u.hasClass("lfb") || u.hasClass("sft") || u.hasClass("sfb")) {
                                                ...
                                                if (e == t)
                                                        e = "linear";
                                                u.data("repx", u.position().left);u.data("repy", u.position().top);u.data("repo", u.css("opacity"));u.animate({
                                                        opacity : 1,
                                                        left : s * u.data("x") + offsetx + "px",
                                                        top : r.bh * u.data("y") + "px"
                                                }, {
        ...
        function L(e , t) {
                e.find(".tp-caption").each(function(n) {
                        ...
                        r.stop(true, true);clearTimeout(r.data("timer"));clearTimeout(r.data("timer-end"));
                        var i = r.data("easing");
                        i = "easeInOutSine";
                        var s = r.data("repx");
                        var o = r.data("repy");
        ...
        function O(e , n) {
                ...
                if (n.stopAfterLoops != t && n.stopAfterLoops > -1)
                        n.looptogo = n.stopAfterLoops;else
                        n.looptogo = 9999999;
                if (n.stopAtSlide != t && n.stopAtSlide > -1)
                        n.lastslidetoshow = n.stopAtSlide;else
                ...
                if (n.slideamount > 1 && !(n.stopAfterLoops == 0 && n.stopAtSlide == 1)) {
                        ...
                        n.cdint = setInterval(function() {
                                if (e.data("conthover-changed") == 1) {
                                        n.conthover = e.data("conthover");e.data("conthover-changed", 0)
                                }
                                if (n.conthover != 1 && n.videoplaying != true && n.width > n.hideSliderAtLimit)
                                        n.cd = n.cd + 100;
                                if (n.fullWidth != "on")
                                        if (n.width > n.hideSliderAtLimit) e.parent().removeClass("tp-hide-revslider");else e.parent().addClass("tp-hide-revslider");
                                ...
                                if (n.cd >= n.delay) {
                                        ...
                                        if (n.stopLoop == "on" && n.next == n.lastslidetoshow - 1) {
                                                clearInterval(n.cdint);e.find(".tp-bannertimer").css({
                                                        visibility : "hidden"
                        ...
                        }, 100);e.hover(function() {
                                if (n.onHoverStop == "on") {
                                        n.conthover = 1;r.stop();e.trigger("revolution.slide.onpause")
                                }
                        }, function() {
        ...
        e.fn.extend({
                revolution : function(r) {
                        ...
                        r = e.extend({}, e.fn.revolution.defaults, r);return this.each(function() {
                                var i = r;
                                var o = e(this);
                                ...
                                e.cssEase["bounce"] = "cubic-bezier(0,1,0.5,1.3)";o.find(".caption").each(function() {
                                ...
                                i.navOV = i.navOffsetVertical;o.append('<div class="tp-loader"></div>');
                                ...
                                if (i.width != i.startwidth) {
                                        i.height = Math.round(i.startheight * (i.width / i.startwidth));o.height(i.height)
                                }
                                if (i.shadow != 0) {
                                        o.parent().append('<div class="tp-bannershadow tp-shadow' + i.shadow + '"></div>');o.parent().find(".tp-bannershadow").css({
                                                width : i.width
                                        })
                                }
